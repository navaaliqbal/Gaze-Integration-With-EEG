"""
Training function for baseline NeuroGATE model (EEG-only, no gaze integration)
"""
import torch
...
def train_epoch_baseline(model, train_loader, optimizer, device, 
    ...
    """
    Training epoch for baseline model (EEG-only)
    
    Args:
        model: Baseline NeuroGATE model
    ...
    for batch_idx, batch in pbar:
        ...
        # Forward pass (baseline model only takes EEG)
        logits = model(eeg)
